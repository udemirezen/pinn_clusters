...
We tested $l = 12$ values of $\gamma$ such that $\frac{\gamma}{1-\gamma}$ are logarithmically spaced between $[10^{-4}, 10^6]$, i.e., ```gi = 0``` corresponds to $10^{-4}$, ```gi = 1``` corresponds to $10^{-3}$,...```gi = 11``` corresponds to $10^{7}$.
