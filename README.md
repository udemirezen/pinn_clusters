...
Ground truth profiles for u and h from which noisy data is generated. "constantB_uh.mat" are the u(x) and h(x) solutions for $B(x) = 1.0$, $x \in [0.0,1.0]$. "sinusoidalB_uh.mat" are the numerical u(x) and h(x) for 
